...
import com.springrecipes.ch03.ch031.court.config.PeriodReservationValidator;
...
public class PeriodicReservationController {
    ...
    private final PeriodReservationValidator validator;


    public PeriodicReservationController(ReservationService reservationService, PeriodReservationValidator validator) {
    ...
    public String submitForm(
            ...
            @ModelAttribute("reservation") PeriodicReservation reservation, BindingResult result, @RequestParam("_page") int currentPage) {
        int targetPage = getTargetPage(request, ".target", currentPage);
    ...
    public String completeForm(@Validated @ModelAttribute("reservation") PeriodicReservation
                                       reservation, BindingResult result, SessionStatus status, @RequestParam("_page") int currentPage) {
        if (!result.hasErrors()) {
